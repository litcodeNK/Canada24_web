...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='Canada 24/7 <noreply@canada247.com>')
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Canada 24/7 API',
    'DESCRIPTION': 'Backend API for Canada 24/7 News App',
    'VERSION': '1.0.0',
